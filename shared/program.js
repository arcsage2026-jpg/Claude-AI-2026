...
export const DAYS = [
  { key: "mon", label: "Mon", title: "Shaolin Strength + Sun", element: "solar", goals: ["Strength", "Cardio"], blocks: [
    { id: "mon-surya-warmup", icon: "sun", name: "Surya Namaskar — warm-up", vol: ["5 rounds slow", "8–10 rounds", "12–15 rounds"], logType: "rounds" },
    { id: "mon-stance-work", icon: "flame", name: "Stance work — Ma Bu + Gong Bu", note: "Horse stance + bow stance", vol: ["30s + 20s/side", "45s + 40s/side", "90s + 60s/side"], logType: "duration" },
    { id: "mon-hindu-pushups", icon: "flame", name: "Hindu push-ups (Dand)", vol: ["3 × 6–8", "4 × 12–15", "5 × 20–25"], logType: "reps" },
    { id: "mon-hindu-squats", icon: "activity", name: "Hindu squats (Baithak)", vol: ["3 × 20", "4 × 40", "5 × 60–100"], logType: "reps" },
    { id: "mon-bear-crawl", icon: "activity", name: "Bear crawl", vol: ["3 × 10m", "4 × 15m", "5 × 20m ↔"], logType: "reps" },
    { id: "mon-cooldown", icon: "wind", name: "Cooldown — pranayama + Shavasana", vol: ["5–8 min", "5–8 min", "8–10 min"], logType: "duration" },
  ]},
  { key: "tue", label: "Tue", title: "Conditioning", element: "solar", goals: ["Cardio", "Stamina"], blocks: [
    { id: "tue-calisthenics-circuit", icon: "activity", name: "Calisthenics circuit", note: "15 squats · 10 push-ups · 10 burpees · 20 mtn climbers · 30s plank", vol: ["2 rounds", "3 rounds", "4 rounds"], logType: "rounds" },
    { id: "tue-fast-surya", icon: "sun", name: "Fast Surya Namaskar", vol: ["5 rounds brisk", "10 rounds fast", "15 rounds fast"], logType: "rounds" },
    { id: "tue-run-intervals", icon: "activity", name: "Run intervals", vol: ["6 × 200m", "8 × 200m", "sprint ladders"], logType: "reps" },
    { id: "tue-cooldown-stretch", icon: "wind", name: "Cooldown stretch", vol: ["5 min", "5 min", "5–8 min"], logType: "duration" },
  ]},
  { key: "wed", label: "Wed", title: "Flow & Flexibility", element: "lunar", goals: ["Flexibility", "Recovery"], blocks: [
    { id: "wed-tai-chi", icon: "moon", name: "Tai Chi", vol: ["8-form · 15 min", "24-form · 20 min", "24-form + silk-reeling · 30 min"], logType: "duration" },
    { id: "wed-chandra-namaskar", icon: "moon", name: "Chandra Namaskar", vol: ["2–4 rounds", "4–6 rounds", "6–8 rounds + holds"], logType: "rounds" },
    { id: "wed-yoga-stretch", icon: "wind", name: "Yoga stretch — ladder", vol: ["Beginner · hold 20–30s", "Intermediate · 30–45s", "Advanced · 45–60s"], logType: "duration" },
    { id: "wed-pranayama", icon: "wind", name: "Pranayama", vol: ["Nadi Shodhana 5 min", "+ Bhramari", "+ extended"], logType: "duration" },
  ]},
  { key: "thu", label: "Thu", title: "Shaolin Power + Pull", element: "solar", goals: ["Strength", "Endurance"], blocks: [
    { id: "thu-surya-warmup", icon: "sun", name: "Surya Namaskar — warm-up", vol: ["3–5 rounds", "8–10 rounds", "12–15 rounds"], logType: "rounds" },
    { id: "thu-shaolin-kicks", icon: "flame", name: "Shaolin kicks — front + crescent", note: "Straight, inside & outside crescent", vol: ["2 × 10 / side", "3 × 10", "3 × 12 + height"], logType: "reps" },
    { id: "thu-pullups", icon: "dumbbell", name: "Pull-ups", vol: ["Dead hang 5×20–30s + neg 4×3", "Band / strict 4×3–5 + hangs", "Strict 5×6–10 + weighted"], logType: "reps+weight" },
    { id: "thu-iron-body-holds", icon: "flame", name: "Iron Body holds — Ma Bu + Fingertip plank", note: "Horse stance + fingertip plank", vol: ["MaBu 30s · FP 10s", "MaBu 45s · FP 25s", "MaBu 90s · FP 40s"], logType: "duration" },
    { id: "thu-hollow-hold", icon: "activity", name: "Core — hollow hold", vol: ["3 × 20s", "4 × 30s", "5 × 40s"], logType: "duration" },
    { id: "thu-cooldown", icon: "wind", name: "Cooldown", vol: ["5 min", "5–8 min", "8 min"], logType: "duration" },
  ]},
  { key: "fri", label: "Fri", title: "Full-Body + Yoga Strength", element: "solar", goals: ["Strength", "Flexibility"], blocks: [
    { id: "fri-calisthenics-circuit", icon: "activity", name: "Calisthenics circuit", note: "push-ups · squats · lunges · burpees · core", vol: ["3 rounds", "4 rounds", "5 rounds"], logType: "rounds" },
    { id: "fri-yoga-holds", icon: "flame", name: "Yoga holds / arm balances", vol: ["Beginner holds 20–30s", "Intermediate + inversion prep", "Advanced arm balances 45–60s"], logType: "duration" },
    { id: "fri-cooldown", icon: "wind", name: "Cooldown", vol: ["5 min", "5–8 min", "8 min"], logType: "duration" },
  ]},
  { key: "sat", label: "Sat", title: "Shaolin Endurance", element: "solar", goals: ["Endurance", "Stamina"], blocks: [
    { id: "sat-surya-warmup", icon: "sun", name: "Surya Namaskar — warm-up", vol: ["5 rounds", "8 rounds", "10 rounds"], logType: "rounds" },
    { id: "sat-shaolin-flow", icon: "flame", name: "Shaolin 25–30 min flow (circuit)", note: "Hindu squats · Dand · bear crawl · bear hug walk · horse stance", vol: ["2 rounds", "3 rounds", "4 rounds"], logType: "rounds" },
    { id: "sat-bear-hug-walk", icon: "flame", name: "Bear hug walk (loaded carry)", note: "Hug a sandbag / stone / heavy pack", vol: ["3 × 20m light", "4 × 30m mod", "5 × 40m heavy"], logType: "reps+weight" },
    { id: "sat-run-ruck", icon: "activity", name: "Run / ruck", vol: ["2 km", "3–4 km", "5 km / ruck"], logType: "duration" },
    { id: "sat-taichi-cooldown", icon: "moon", name: "Tai Chi cooldown", vol: ["10 min", "10–15 min", "15 min"], logType: "duration" },
  ]},
